...
import { useEpicImages } from '../../presentation/useEpicImages';
import { useTheme } from '@react-navigation/native';

const { width } = Dimensions.get('window');

export default function EpicScreen() {
  const today = dayjs().subtract(1, 'day').format('YYYY-MM-DD'); // EPIC publica con ~1 día de retraso
...
const styles = StyleSheet.create({
  ...
  image: { width, height: width }, // cuadrado
});
